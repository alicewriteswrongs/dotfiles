...
alias djstestdebug='node --inspect ./node_modules/mocha/bin/_mocha --require ./static/js/babelhook.js static/js/global_init.js static/**/*/*_test.js'
...
alias dwatch='docker-compose run watch npm run watch'
...
alias gfmt='npm run fmt && git commit -a -m "fmt"'
...
alias rebuildstencil='npm run clean && npm ci && npm run build && npm pack'
...
alias narrowprettier='npm run prettier.base -- --print-width 80 --write'
alias fmt='npm run prettier'
